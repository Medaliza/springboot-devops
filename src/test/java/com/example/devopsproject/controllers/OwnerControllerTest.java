...
public class OwnerControllerTest {
    ...
    void testGetOwnersSuccess() throws Exception {
        ...
        Owner owner1 = new Owner("mohamed ali", 26);
        Owner owner2 = new Owner("khalil", 25);
        ...
        mockMvc.perform(get("/owner/all"))
                ...
                .andExpect(jsonPath("$[0].name", is("mohamed ali")))
                .andExpect(jsonPath("$[0].age", is(26)))
                .andExpect(jsonPath("$[1].name", is("khalil")))
    ...
    void testGetOwnerById() throws Exception {
        ...
        Owner owner = new Owner(1l,"mohamed ali", 26);
    ...
    void testCreateWidget() throws Exception {
        // Set up our mocked service
        Owner ownerToCreate = new Owner("mohamed ali",12 );
        Owner ownerToReturn = new Owner(1L, "mohamed ali",12);
